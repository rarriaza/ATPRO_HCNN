...
from models.distillation.generalist import Generalist
...
def main(args):
    ...
    #                             args=args)
    generalist = Generalist(n_fine_categories=n_fine_categories,
                            n_coarse_categories=n_coarse_categories,
                            input_shape=input_shape,
                            generalist_model_file=args.load_generalist,
                            logs_directory=logs_directory,
                            model_directory=model_directory,
                            args=args)
    specialists = []
...
def parse_arguments():
    ...
    parser.add_argument('--load_generalist', help='Load trained generalist',
