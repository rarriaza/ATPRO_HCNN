...
class HatCNN:
    ...
    def build_cc_fc(self, verbose=True):
        ...
        # Attention
        feature_map_att = SelfAttention(fc_in_1.shape[-1], fc_in_1.shape[-2], 0.0)(fc_in_1, 0, True)
        feature_map_att = NormL()(feature_map_att)

        # FC Model
        fc = tf.keras.layers.Conv2D(128, kernel_size, strides=(1, 1), padding='same')(feature_map_att)
